...
//  ace.handle_profile_settings(jQuery);
...
//ace.handle_profile_settings = function($) {
//  $('#profile_settings').on(ace.click_event, function () {
//    alert('hi');
////    $('#profile_settings').parent().toggleClass('open');
//    return false;
//  });
//}
